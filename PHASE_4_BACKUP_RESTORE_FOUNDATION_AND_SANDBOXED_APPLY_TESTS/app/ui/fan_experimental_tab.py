...
class FanExperimentalTab(QWidget):
    def __init__(self, window) -> None:
        ...
        layout.addWidget(QLabel("Experimental/read-only. Fan apply, service control, config writes, and EC writes are blocked in Phase 3."))
        ...
        blocked.setPlainText(
            "\n".join(
                [
                    ...
                    "- Direct EC write: blocked as dangerous/research-only.",
