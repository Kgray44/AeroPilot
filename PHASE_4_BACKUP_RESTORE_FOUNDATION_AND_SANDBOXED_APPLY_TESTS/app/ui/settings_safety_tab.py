...
class SettingsSafetyTab(QWidget):
    def __init__(self, window) -> None:
        ...
        layout.addWidget(QLabel("Phase 4 apply gates keep active plan writes, MSI profile launches, fan writes, blocked EC writes, and automation apply disabled."))
        ...
        layout.addWidget(QLabel("Phase 4 backup / restore / apply gates"))
