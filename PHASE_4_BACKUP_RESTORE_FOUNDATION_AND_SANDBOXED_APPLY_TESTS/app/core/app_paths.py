...
class AppPaths:
    ...
    def discover(cls) -> "AppPaths":
        ...
        return cls(
            ...
            logs_dir=phase4_root / "logs",
            raw_outputs_dir=phase4_root / "raw_outputs",
            screenshots_dir=phase4_root / "screenshots",
            config_dir=phase4_root / "config",
            presets_dir=phase4_root / "presets",
            docs_dir=phase4_root / "docs",
            restore_dir=phase4_root / "restore",
        )
    ...
    def require_inside_phase4(self, path: Path) -> Path:
        ...
        if resolved != root and root not in resolved.parents:
            raise ValueError(f"Refusing to write outside Phase 4 root: {resolved}")
        return resolved
