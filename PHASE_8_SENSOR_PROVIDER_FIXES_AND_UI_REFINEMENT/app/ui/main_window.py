...
from app.adapters.cpu_telemetry_adapter import CpuTelemetryAdapter
...
class MainWindow(QMainWindow):
    def __init__(self, paths: Path) -> None:
        ...
        self.cpu_telemetry = CpuTelemetryAdapter(self.runner, self.phase1.librehardwaremonitor(), paths.phase4_root)
