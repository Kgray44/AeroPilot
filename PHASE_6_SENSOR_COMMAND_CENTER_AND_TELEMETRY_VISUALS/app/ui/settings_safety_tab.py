...
class SettingsSafetyTab(QWidget):
    def __init__(self, window) -> None:
        ...
        layout.addWidget(QLabel("Phase 6 is telemetry and UI only. Active plan writes, MSI profile launches, fan controls, embedded-controller paths, and automation apply remain disabled unless future backup/restore gates are explicitly proven."))
