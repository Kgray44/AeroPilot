...
class SettingsSafetyTab(QWidget):
    def __init__(self, window) -> None:
        ...
        layout.addWidget(QLabel("Phase 5 apply gates keep active plan writes, MSI profile launches, fan controls, embedded-controller paths, and automation apply disabled unless backup/restore gates are proven."))
